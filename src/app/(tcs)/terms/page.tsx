    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <main className="max-w-3xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <section className="mt-10">
          ...
          <p className="mb-4">
            ScheduleBuddy has the right but not the obligation to monitor and
            edit all Content provided by users. In addition, Content found on or
            through this Service are the property of ScheduleBuddy or used with
        ...
        <section className="mt-10">
          ...
          <p className="mb-4">
            We also encourage you to review Google policy for safeguarding your
            data.
          </p>
        </section>
        ...
        <section className="mt-10">
          ...
          <p className="mb-4">
            ...
            eighteen (18) years old. By accessing or using any part of
            ScheduleBuddy, you warrant and represent that you are at least
            eighteen (18) years of age and have the full authority, right, and
        ...
        <section className="mt-10">
          ...
          <p className="mb-4">
            ...
            property of ScheduleBuddy and its licensors. Service is protected by
        ...
        <section className="mt-10">
          ...
          <p className="mb-4">
            ...
            email to dmca@schedulebuddy, with the subject line: “Copyright
          ...
          <p className="mb-4">
            ...
            regarding any Content found on and/or through Service.
          </p>
        </section>
        ...
        <section className="mt-10">
          ...
          <ul className="list-disc list-inside mb-4">
            ...
            <li>
              ...
              infringed, including the URL or a copy of the work;
            </li>
            <li>
              Identification of the URL or location where the infringing
              material is located;
            </li>
        ...
        <section className="mt-10">
          ...
          <p className="mb-4">
            You may provide us directly at support@schedulebuddy or via
            third-party sites and tools with information and feedback concerning
            errors, suggestions, ideas, problems, complaints, and other matters
            related to our Service (&quot;Feedback&quot;).
          </p>
          <p className="mb-4">
            You acknowledge and agree that: (i) you shall not retain any
            intellectual property right in Feedback; (ii) ScheduleBuddy may have
            development ideas similar to Feedback; (iii) Feedback does not
            contain confidential information from you or any third party; (iv)
            ScheduleBuddy is not under any obligation of confidentiality
            regarding the Feedback.
          </p>
          <p className="mb-4">
            In the event transfer of ownership to Feedback is not possible due
            to laws, you grant ScheduleBuddy and its affiliates an exclusive,
            transferable, irrevocable, free-of-charge, sub-licensable, unlimited
            and perpetual right to use Feedback for any purpose.
          </p>
          <p className="mb-4">
          ...
          <ul className="list-disc list-inside mb-4">
            <li>
              Sentry: An open-source error tracking solution by Functional
              Software Inc.{" "}
              <a
            ...
            <li>
              Raygun: Automated error monitoring software by Raygun Limited.{" "}
              <a
                href="https://raygun.com/privacy/"
                className="underline text-blue-600"
              >
                Privacy Policy
              </a>
        ...
        <section className="mt-10">
          ...
          <p className="mb-4">
            ...
            not owned or controlled by ScheduleBuddy.
          </p>
          <p className="mb-4">
            ScheduleBuddy has no control over, and assumes no responsibility
            for, the content, privacy policies, or practices of any third-party
            websites or services. We do not warrant the offerings of any of
            these entities or individuals.
          </p>
          <p className="mb-4">
            YOU ACKNOWLEDGE AND AGREE THAT SCHEDULEBUDDY SHALL NOT BE
            RESPONSIBLE OR LIABLE FOR ANY DAMAGE OR LOSS CAUSED BY OR IN
            CONNECTION WITH USE OF OR RELIANCE ON ANY SUCH CONTENT OR SERVICES
        ...
        <section className="mt-10">
          ...
          <p className="mb-4">
            ...
            AVAILABLE” BASIS. COMPANY MAKES NO WARRANTIES, EXPRESS OR IMPLIED,
            ABOUT THE SERVICES OR THEIR CONTENT.
          </p>
          <p className="mb-4">
            COMPANY DISCLAIMS ALL WARRANTIES INCLUDING MERCHANTABILITY,
        ...
        <section className="mt-10">
          ...
          <p className="mb-4">
            EXCEPT AS PROHIBITED BY LAW, YOU AGREE TO HOLD US AND OUR OFFICERS,
            DIRECTORS, EMPLOYEES, AND AGENTS HARMLESS FOR ANY INDIRECT,
            PUNITIVE, INCIDENTAL, OR CONSEQUENTIAL DAMAGES ARISING OUT OF THIS
        ...
        <section className="mt-10">
          ...
          <p className="mb-4">
            ...
            notice, under our sole discretion, for any reason including breach
            of Terms.
          </p>
          <p className="mb-4">
        ...
        <section className="mt-10">
          ...
          <p className="mb-4">
            We reserve the right to withdraw or amend our Service at any time
            without notice. We will not be liable if Service is unavailable for
            any reason.
          </p>
        </section>
        ...
        <section className="mt-10">
          ...
          <p className="mb-4">
            We may amend Terms by posting updated Terms. Your continued use
            after revisions means you accept the changes.
          </p>
        </section>
        ...
        <section className="mt-10">
          ...
          <p className="mb-4">
            No waiver by Company shall be deemed a waiver of any other term. If
            any provision is held invalid, the remaining Terms remain effective.
          </p>
        </section>
        ...
        <section className="mt-10">
          ...
          <p className="mb-4">
            BY USING SERVICE, YOU ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS AND
        ...
        <section className="mt-10">
          ...
          <p className="mb-4">
            ...
            email: support@schedulebuddy.cloud
          </p>
        </section>
      </main>
    </div>
